...
namespace IdentityServerQuickStartWithUI
{
        ...
        public static IEnumerable<Client> GetClients()
        {
            return new List<Client>
            {
                ...
                new Client
                {
                    ...
                    RedirectUris =           { "http://localhost:60004/callback.html" },
                    PostLogoutRedirectUris = { "http://localhost:60004/index.html" },
                    AllowedCorsOrigins =     { "http://localhost:60004" },
